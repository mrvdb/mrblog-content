...
#+BEGIN_HTML
<img style="width: 400px; margin: 15px; float: left;" alt="Google search trend" title="Google search trend"
     src="http://mrblog.nl/files/2011/06/wpid-btc-trend.png"/>
#+END_HTML
...
#+BEGIN_HTML
  <img style="float:right; width:300px;" alt="Broken trust" title="Broken trust?"
       src="http://mrblog.nl/files/2011/06/wpid-trust.jpg"/>
#+END_HTML
...
#+BEGIN_HTML
  <img style="width: 320px; margin: 15px; float:left;" alt="Verdict form"
       title="Verdict form"
  src="http://mrblog.nl/files/2011/06/wpid-verdict.jpg" />
#+END_HTML
