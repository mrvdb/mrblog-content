...
---
#+END_HTML
<p>Worked a bit on the&amp;nbsp; <em>blog by email</em> stuff. Sanitized the script a bit. The posting should now be a bit more clean as the backend now only includes stuff between the body tags of the received html. Nowhere near rock-solid, but useable nevertheless.</p>
