...
published: true
meta:
  bitcointips_address: 1CiDNQM2cSAFhhnYY7gQiV6yBEKVszikQU
---
#+END_HTML
<p>I decided to disable comments alltogether on this blog. The amount of time required to manage the ip banning and deleting the spam comments is getting too much in comparison with the small scale blogging i do over here.</p>
